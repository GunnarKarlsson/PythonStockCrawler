#http://www.aastocks.com/en/stocks/analysis/company-fundamental/balance-sheet?symbol=00002
import pymongo
import pprint
import sys
...
count = 0;
for x in collection.find({ "P/B": { "$lt": lower_than }}).sort([("P/B", pymongo.ASCENDING)]):
